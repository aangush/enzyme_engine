    ...
    def _extract_embl_locations(self, data):
        ...
        for ref in xrefs:
            if ref["database"] == "EMBL":
                embl_acc = ref["id"]
                # UniProt EMBL xrefs don't always contain perfect genomic coordinates in the properties.
                # For robust mapping, you typically extract the ProteinId and map it.
                # Here we capture the EMBL contig accession to query ENA directly.
